...
"""Resolve the primitive simulator before opening the coordinator's hardware adapter."""
...
class R1ProPrimitiveCoordinator(ControlCoordinator):
    _primitive_sim: PrimitiveSimSpec

    @rpc
    def build(self) -> None:
        session = self._primitive_sim.prepare_primitive_session()
