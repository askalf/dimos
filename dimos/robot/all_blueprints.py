...
all_blueprints = {
    ...
    "behavior-agentic": "dimos.simulation.behavior.blueprints:behavior_agentic",
    "behavior-nav": "dimos.simulation.behavior.blueprints:behavior_nav",
    "behavior-r1pro": "dimos.simulation.behavior.blueprints:behavior_r1pro",
    "behavior-task": "dimos.simulation.behavior.blueprints:behavior_task",
    "behavior-teleop": "dimos.simulation.behavior.blueprints:behavior_teleop",
    ...
    "dual-openyam-policy-quest-rollout": "dimos.robot.manipulators.dual_openyam.blueprints.learning_rollout:dual_openyam_policy_quest_rollout",
    "dual-openyam-policy-rollout": "dimos.robot.manipulators.dual_openyam.blueprints.learning_rollout:dual_openyam_policy_rollout",
    ...
    "openyam-policy-quest-rollout": "dimos.robot.manipulators.openyam.blueprints.learning_rollout:openyam_policy_quest_rollout",
    "openyam-policy-rollout": "dimos.robot.manipulators.openyam.blueprints.learning_rollout:openyam_policy_rollout",
...
all_modules = {
    ...
    "behavior-connection": "dimos.simulation.behavior.connection.BehaviorConnection",
    "behavior-coordinator": "dimos.simulation.behavior.r1pro_bridge.BehaviorCoordinator",
    "behavior-probe": "dimos.simulation.behavior.probe.BehaviorProbe",
    "behavior-r1-pro-bridge": "dimos.simulation.behavior.r1pro_bridge.BehaviorR1ProBridge",
    "behavior-skills": "dimos.simulation.behavior.skills.BehaviorSkills",
    ...
    "policy-module": "dimos.imitation.policy.module.PolicyModule",
