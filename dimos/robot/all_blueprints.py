...
all_modules = {
    ...
    "cmd-vel-mux-native": "dimos.navigation.movement_manager.cmd_vel_mux_native.CmdVelMuxNative",
    ...
    "go2-tf": "dimos.robot.unitree.go2.tf.go2_tf.Go2Tf",
    ...
    "motion-planner-native": "dimos.navigation.motion.adapter.planner_native.MotionPlannerNative",
    ...
    "trajectory-follower": "dimos.navigation.motion.adapter.follower.TrajectoryFollower",
    "trajectory-follower-native": "dimos.navigation.motion.adapter.follower_native.TrajectoryFollowerNative",
