...
all_blueprints = {
    ...
    "dual-openyam-sim": "dimos.robot.manipulators.dual_openyam.blueprints.simulation:dual_openyam_sim",
    "dual-openyam-sim-agent": "dimos.robot.manipulators.dual_openyam.blueprints.agentic:dual_openyam_sim_agent",
    "dual-openyam-sim-pick-place": "dimos.robot.manipulators.dual_openyam.blueprints.simulation:dual_openyam_sim_pick_place",
    "dual-openyam-sim-policy-agent": "dimos.robot.manipulators.dual_openyam.blueprints.agentic:dual_openyam_sim_policy_agent",
    ...
    "r1pro-apartment-sim": "dimos.robot.galaxea.r1pro.apartment_blueprint:r1pro_apartment_sim",
    "r1pro-apartment-sim-agent": "dimos.robot.galaxea.r1pro.apartment_blueprint:r1pro_apartment_sim_agent",
    "r1pro-classical-apartment-sim": "dimos.robot.galaxea.r1pro.classical_blueprint:r1pro_classical_apartment_sim",
    "r1pro-classical-apartment-sim-agent": "dimos.robot.galaxea.r1pro.classical_blueprint:r1pro_classical_apartment_sim_agent",
    "r1pro-classical-open-space-sim": "dimos.robot.galaxea.r1pro.open_space_blueprint:r1pro_classical_open_space_sim",
    "r1pro-classical-open-space-sim-agent": "dimos.robot.galaxea.r1pro.open_space_blueprint:r1pro_classical_open_space_sim_agent",
    "r1pro-coordinator": "dimos.robot.galaxea.r1pro.blueprints.basic.r1pro_coordinator:r1pro_coordinator",
    "r1pro-home-sim": "dimos.robot.galaxea.r1pro.home_blueprint:r1pro_home_sim",
    "r1pro-home-sim-agent": "dimos.robot.galaxea.r1pro.home_agent_blueprint:r1pro_home_sim_agent",
    ...
    "xarm-privileged-sim": "dimos.robot.manipulators.xarm.blueprints.simulation:xarm_privileged_sim",
...
all_modules = {
    ...
    "apartment-navigation": "dimos.robot.galaxea.r1pro.apartment_navigation.ApartmentNavigation",
    ...
    "r1-pro-apartment-coordinator": "dimos.robot.galaxea.r1pro.apartment_coordinator.R1ProApartmentCoordinator",
    "r1-pro-apartment-sim": "dimos.robot.galaxea.r1pro.apartment_sim.R1ProApartmentSim",
    "r1-pro-apartment-skills": "dimos.robot.galaxea.r1pro.apartment_skills.R1ProApartmentSkills",
    "r1-pro-classical-sim": "dimos.robot.galaxea.r1pro.classical_sim.R1ProClassicalSim",
    "r1-pro-classical-skills": "dimos.robot.galaxea.r1pro.classical_skills.R1ProClassicalSkills",
    ...
    "r1-pro-home-coordinator": "dimos.robot.galaxea.r1pro.home_coordinator.R1ProHomeCoordinator",
    "r1-pro-home-demo": "dimos.robot.galaxea.r1pro.home_sim.R1ProHomeDemo",
    "r1-pro-home-sim": "dimos.robot.galaxea.r1pro.home_sim.R1ProHomeSim",
    ...
    "r1-pro-object-coordinator": "dimos.robot.galaxea.r1pro.object_coordinator.R1ProObjectCoordinator",
    "r1-pro-object-packing-sim": "dimos.robot.galaxea.r1pro.object_packing_sim.R1ProObjectPackingSim",
    "r1-pro-object-skills": "dimos.robot.galaxea.r1pro.object_skills.R1ProObjectSkills",
    "r1-pro-open-space-sim": "dimos.robot.galaxea.r1pro.open_space_sim.R1ProOpenSpaceSim",
    "r1-pro-packing-sim": "dimos.robot.galaxea.r1pro.packing_blueprint.R1ProPackingSim",
    "r1-pro-primitive-coordinator": "dimos.robot.galaxea.r1pro.primitive_coordinator.R1ProPrimitiveCoordinator",
    "r1-pro-primitive-sim": "dimos.robot.galaxea.r1pro.primitive_sim.R1ProPrimitiveSim",
    "r1-pro-primitive-skills": "dimos.robot.galaxea.r1pro.primitive_skills.R1ProPrimitiveSkills",
    ...
    "sim-demo-skills": "dimos.robot.manipulators.dual_openyam.sim_demo.SimDemoSkills",
    "sim-scene-registration-module": "dimos.simulation.perception.sim_scene_registration.SimSceneRegistrationModule",
