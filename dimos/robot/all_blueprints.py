...
all_blueprints = {
    ...
    "unitree-go2-typesafe": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_typesafe:unitree_go2_typesafe",
    "unitree-go2-typesafe-demo": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_typesafe_demo:unitree_go2_typesafe_demo",
...
all_modules = {
    ...
    "demo-objects": "dimos.agents.typesafe.demo_objects.DemoObjects",
