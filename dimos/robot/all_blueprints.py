...
all_blueprints = {
    ...
    "go2-localize-live": "dimos.perception.memory.blueprints.go2_localize_live:go2_localize_live",
...
all_modules = {
    ...
    "localize-module": "dimos.perception.memory.blueprints.go2_localize_live.LocalizeModule",
    "loop-feeder": "dimos.perception.memory.blueprints.go2_localize_live.LoopFeeder",
