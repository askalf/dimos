...
all_blueprints = {
    ...
    "demo-hyperspace": "dimos.mapping.hyperspace.blueprints:demo_hyperspace",
    "demo-hyperspace-segments": "dimos.mapping.hyperspace.blueprints:demo_hyperspace_segments",
    ...
    "go2-localize-live": "dimos.perception.memory.demo_blueprints.go2_localize_live:go2_localize_live",
    ...
    "memory-world-hyperspace": "dimos.teleop.memory_world.blueprints:memory_world_hyperspace",
    ...
    "xarm-feed": "dimos.perception.memory.demo_blueprints.xarm_feed:xarm_feed",
    ...
    "xarm-localize-live": "dimos.perception.memory.demo_blueprints.xarm_localize_live:xarm_localize_live",
...
all_modules = {
    ...
    "depth-camera-feed": "dimos.perception.memory.demo_blueprints.xarm_feed.DepthCameraFeed",
    ...
    "hyperspace-patches": "dimos.mapping.hyperspace.module.HyperspacePatches",
    "hyperspace-replay": "dimos.mapping.hyperspace.replay.HyperspaceReplay",
    "hyperspace-segments": "dimos.mapping.hyperspace.segments_module.HyperspaceSegments",
    ...
    "live-localize-module": "dimos.perception.memory.demo_blueprints.live_localize.LiveLocalizeModule",
    "local-map-relocalization": "dimos.mapping.relocalization.lidar.module.LocalMapRelocalization",
    "localize-module": "dimos.perception.memory.demo_blueprints.go2_localize_live.LocalizeModule",
    "loop-feeder": "dimos.perception.memory.demo_blueprints.go2_localize_live.LoopFeeder",
    ...
    "memory-world-module": "dimos.teleop.memory_world.module.MemoryWorldModule",
